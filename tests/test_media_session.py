...
def test_play_pause_sync_worker_state():
    ...
    must ALSO notify the worker so sentencePipeline.isPaused and the floating
    control bar stay in sync."""
    src = _source()
    ...
    # Sync must touch the pipeline flag and the control bar.
